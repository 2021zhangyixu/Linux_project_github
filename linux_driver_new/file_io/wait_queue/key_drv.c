...
typedef struct chr_drv {
    ...
    struct irq_resource irq_res; /*< Interrupt resource */
...
static int key_drver_probe(struct platform_device *pdev)
{
    ...
    s_char_drv.chr_class = class_create(THIS_MODULE,"wait_queue_class");
    ...
    s_char_drv.chr_device = device_create(s_char_drv.chr_class,NULL,s_char_drv.dev_num,NULL,"wait_queue_device");
